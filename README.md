# News Portal — новостной портал с SSR и админ-панелью

Полнофункциональный медиа-сайт на Next.js + FastAPI: публикация новостей, поиск, комментарии с реакциями и админ-панель для редакции.
