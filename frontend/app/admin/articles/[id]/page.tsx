  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setForm({
        ...
        category_id: article.category_id ? String(article.category_id) : (article.category?.id ? String(article.category.id) : ''),
        author_id: article.author_id ? String(article.author_id) : (article.author?.id ? String(article.author.id) : ''),
    ...
    <AdminGuard>
      <div className="p-8 max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Редактировать статью</h1>
